...
└── src/verificador_dpp/
    ...
    ├── relatorio_emissao_html.py           # Recibo HTML local pos-emissao (todos os atores)
    └── relatorio_reciclagem_html.py        # Relatorio HTML local adicional (so reciclagem): materiais recuperados + rastreabilidade reversa
```
